...
while True:
    ...
    if "yes" in money:
        ...
        print("total_bill before discount and tips is :",sum(expenses))
        total_bill = sum(expenses)           
        break
    elif "no" in money:
        total_bill = int(input("enter the total_bill before discount and tips:"))
        break
    else:
        print("invalid input ....")
    ...
    if  "yes" in ask:
        ...
        if n1 == 0 or n1 > num_people:
            ...
            while True :
                ...
                if final_bill == total_bill2:
                    print(f"the total bill of expense {final_bill} and the amount paid by {records} matches.\n the total bill is :{total_bill} ")
                    tip_amount = total_bill * (tip_percentage / 100)
                    final_bill = total_bill + tip_amount
                    per_person = final_bill/num_people
                    
                    print("\n--- Bill Summary ---\n")
                    print("the final bill after all calculation : ", final_bill)
                    ...
                    print("number of people not paid:", num_not_paid)        
                    print(" person not paid are :", not_paid)
                    per_person = final_bill/num_people
                    print("Final bill amount excluding tip:", total_bill)
                    print("Tip amount:", tip_amount)
                    print("Final bill including tip:", final_bill)
...
final_bill = total_bill + tip_amount
per_person = final_bill/num_people
print("the final b ill after all calculation : ", final_bill)
print("\n--- Bill Summary ---\n")
if final_bill > total_buget:
        print("Warning: The total bill including tip exceeds your budget!\n")
elif final_bill < total_buget:
